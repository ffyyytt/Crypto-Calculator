...
enum class AESKeyLength { AES_128, AES_192, AES_256, SQUARE };
...
private:
    ...
    static void Rcon(unsigned char* a, unsigned int n);
...
public:
    ...
    static unsigned char findKey(int position, std::vector<std::vector<std::vector<unsigned char>>> ciphertexts);

    static void squareAttack(const char filename[], unsigned char key[]);

    static void generatePlainTextForSquareAttack(const char filename[]);
    ...
    void EncryptListInFile(const char inputFileName[], const char outputFileName[], int n,
    ...
    static void printHexVector(std::vector<unsigned char> a);
};
